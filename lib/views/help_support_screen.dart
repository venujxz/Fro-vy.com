          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildContactTile(Icons.chat_bubble_outline, "Live Chat",
                        "Available 9am - 6pm EST"),
                    const Divider(height: 30),
                    _buildContactTile(Icons.email_outlined, "Email Support",
                        "support@fro-vy.com"),
                    const Divider(height: 30),
                    _buildContactTile(Icons.phone_outlined, "Phone Support",
                        "1-800-FRO-VY-HELP"),
                  ],
                ),
              ),
    ...
    return Row(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color:
                frovyGreen.withValues(alpha: 0.8), // Slightly darker circle bg
