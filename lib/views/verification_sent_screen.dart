...
class _VerificationSentScreenState extends State<VerificationSentScreen> {
  ...
  void initState() {
    ...
    // schedule navigation after a short delay rather than relying on
    // a post‑frame callback.  This is simpler and avoids any chance the
    // callback never fires when the widget tree is modified by
    // Navigator.pushReplacement from the previous screen.
