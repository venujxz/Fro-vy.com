                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildProfileRow(
                              "Allergies", "Peanuts, Shellfish", textColor),
                          _buildProfileRow(
                              "Medical Conditions", "None", textColor),
                          _buildProfileRow(
                              "Other Sensitivities", "Lactose", textColor),
                        ],
                      ),
                    ),

                    const SizedBox(height: 24),
                    Text("How would you like to check ingredients?",
                        style: TextStyle(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              ...
                              style: TextStyle(color: textColor)),
                          Text("• Get instant risk assessment",
                              style: TextStyle(color: textColor)),
                        ],
                      ),
                    ),
